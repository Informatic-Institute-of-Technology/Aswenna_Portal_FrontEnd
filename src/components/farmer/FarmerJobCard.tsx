...
interface FarmerJobCardProps {
  ...
  onHire?: (job: FarmerJob) => void;
}

const FarmerJobCard: React.FC<FarmerJobCardProps> = ({
  job,
  onViewMore,
  onConnect,
  onHire,
          ...
          <Box
            sx={{
              ...
              "&::before": {
                ...
                borderRadius: "50%",
                background:
                  "linear-gradient(135deg, var(--surface-muted) 0%, var(--surface-muted) 100%)",
                zIndex: 0,
              },
            }}
          >
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  LKR {(commissionJob.rate / 1000).toFixed(0)},
                  {(commissionJob.rate % 1000).toString().padStart(3, "0")}/
                  {commissionJob.rateType === "PER_ACRE" ? "acre" : "day"}
                </Typography>
              </Box>
              <Box sx={{ px: 1 }}>
                <Typography
        ...
        >
          ...
          <Box sx={{ flexGrow: 1 }}>
            <Typography
              variant="body2"
              fontWeight="600"
              sx={{ color: "var(--text-primary)", fontSize: "0.9rem" }}
            >
              {job.farmerName}
            </Typography>
            <Typography
          ...
          <>
            ...
            <Box sx={{ mb: 2 }}>
              ...
              >
                <Typography
                  variant="caption"
                  sx={{ color: "var(--text-on-dark)", fontSize: "0.7rem" }}
                >
                  Progress
                </Typography>
                <Typography
          ...
          <>
            <Box sx={{ display: "flex", gap: 2, mb: 2 }}>
              <Box sx={{ flex: 1 }}>
                ...
                <Typography
                  variant="caption"
                  sx={{ color: "var(--text-on-dark)", fontSize: "0.65rem" }}
                >
