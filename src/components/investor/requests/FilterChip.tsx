...
const FilterChip = ({ icon, label, variant, onClick }: FilterChipProps) => {
  const getVariantStyles = () => {
    switch (variant) {
      ...
      case 'verified':
        return 'bg-green-100 dark:bg-green-900/10 text-green-700 dark:text-green-400 border-green-200 dark:border-green-900/30 hover:bg-green-200 dark:hover:bg-green-900/20';
      default:
        return '';
    }
  };
