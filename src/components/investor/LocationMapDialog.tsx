...
const getRoleColor = (
  ...
  const colors = {
    farmer: "var(--color-success)",
    investor: "var(--color-info-blue)",
    landowner: "var(--color-orange)",
    project: "#E91E63",
  };
  return colors[role];
};
...
const LocationMapDialog = ({
  ...
  const [selectedMember, setSelectedMember] = useState<
    (PartyMember & { position: { lat: number; lng: number } }) | null
  >(null);
    ...
    if (member.coordinates) {
      ...
      if (memberCoords) {
        ...
        console.log(
          ...
          position,
          isSameAsProject ? "(OFFSET APPLIED)" : "(ORIGINAL)",
        );
      } else {
        console.warn(
          `Invalid coordinates for ${member.role} - ${member.name}: ${member.coordinates}`,
        );
      }
    } else {
  ...
  return (
    ...
    >
      <DialogTitle sx={{ borderBottom: "1px solid var(--surface-light)" }}>
        <Box display="flex" justifyContent="space-between" alignItems="center">
          <Box>
            ...
            >
              <LocationOn sx={{ color: "var(--color-lime)" }} />
      ...
      <DialogContent sx={{ p: 0 }}>
        ...
        <Box sx={{ p: 2, bgcolor: "var(--surface-muted)" }}>
          ...
          <TableContainer
            component={Paper}
            sx={{ bgcolor: "var(--bg-overlay)" }}
          >
            <Table>
              <TableHead>
                <TableRow sx={{ bgcolor: "var(--surface-light)" }}>
              ...
              <TableBody>
                ...
                >
                  ...
                  <TableCell sx={{ color: "var(--text-on-dark)" }}>
                  ...
                  >
                    <TableCell sx={{ color: "white" }}>
                      ...
                      >
                        <Avatar
                          src={
                            member.role === "investor" && !member.image
