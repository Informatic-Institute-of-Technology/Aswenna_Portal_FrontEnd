...
const mockActivities: SystemActivity[] = [
  {
    ...
    target: { id: 'PRJ-145', name: 'Coconut Plantation Project', type: 'project' },
    action: 'Signed Tri-Party Agreement',
    description: 'Farmer Prasanna Silva signed the tri-party agreement with Investor B and Landowner C',
  ...
  },
  {
    ...
    target: { id: 'TXN-2026-00234', name: 'Payment Transaction', type: 'transaction' },
    action: 'Payment Completed',
    description: 'Payment of 250,000 LKR completed for Project Rice Cultivation - Milestone 2',
    ipAddress: '10.0.1.42',
  },
  {
    id: '3',
    ...
    description: 'Milestone "Land Preparation" marked as complete and submitted for approval',
  ...
  },
  {
    ...
    description: 'Landowner raised a dispute regarding delayed rent payment for Tea Plantation project',
  ...
  },
  {
    ...
    actor: { id: 'INV-012', name: 'Green Future Investments', role: 'investor' },
    target: { id: 'MIL-456', name: 'Site Survey', type: 'project' },
    action: 'Milestone Approved',
    description: 'Investor approved milestone "Site Survey" - Payment released from escrow',
    ipAddress: '10.0.1.42',
  },
  {
    id: '7',
    ...
    description: 'Created new project "Vegetable Farm - Kurunegala" and invited parties',
  ...
  },
  {
    ...
    description: 'Investor identity verification completed successfully - All documents approved',
    ipAddress: '10.0.1.88',
  },
  {
    id: '9',
    ...
    description: 'Landowner uploaded land deed certificate for property verification',
  ...
  },
  {
    ...
    actor: { id: 'ADMIN-001', name: 'System Administrator', role: 'superadmin' },
    target: { id: 'DIS-023', name: 'Payment Dispute', type: 'project' },
    action: 'Dispute Resolved',
    description: 'Dispute resolved between Farmer and Landowner - Payment processed',
    ipAddress: '10.0.0.1',
  },
  {
    id: '11',
  ...
  },
  {
    ...
    actor: { id: 'INV-034', name: 'Agri Ventures PLC', role: 'investor' },
    target: { id: 'TXN-2026-00233', name: 'Escrow Deposit', type: 'transaction' },
    action: 'Payment Initiated',
    description: 'Initiated escrow deposit of 500,000 LKR for Fruit Orchard project',
    ipAddress: '10.0.1.88',
  },
];
...
const SystemActivityLog = () => {
  ...
  const filteredActivities = activities.filter((activity) => {
    ...
    const matchesRole = roleFilter === 'all' || activity.actor.role === roleFilter;
    const matchesSearch =
                    ...
                    <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
                      {activity.target && (
                        <Typography variant="caption" color="text.secondary">
                          Target: <strong>{activity.target.name}</strong> ({activity.target.type})
                        </Typography>
                      )}
                      {activity.ipAddress && (
                        <Typography variant="caption" color="text.secondary">
