...
const RoleSelection = () => {
  ...
  const roles = [
    {
      ...
      title: "Farmer",
      description:
        "Access the resources you need to grow. Connect with investors for funding, find arable land for lease, and manage your agricultural projects efficiently in one place.",
    },
    {
      id: "investor" as const,
      title: "Investor",
      description:
        "Diversify your portfolio with direct agricultural investments. Browse vetted opportunities, fund capable farmers, and track project performance transparently.",
    },
    {
  ...
  const handleRoleSelect = (role: Role) => {
    ...
    showSuccess(
      `Role selected: ${role.charAt(0).toUpperCase() + role.slice(1)}`,
    );
    ...
    <Box className="role-selection-container">
      <Container maxWidth="xl">
        ...
        <Box sx={{ textAlign: "center", mb: 4 }}>
          ...
          >
            Select your role to customize your Aswenna experience. This helps us
            provide the right tools for your growth.
          </Typography>
        </Box>
